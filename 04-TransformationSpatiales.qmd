...
-   La **segmentation** (SLIC) réduit l'image en **super-pixels** homogènes ; le **graphe d'adjacence (RAG)** fusionne les segments ; l'**approche objet** (`regionprops`) décrit chaque segment par des propriétés.
:::
::::::
