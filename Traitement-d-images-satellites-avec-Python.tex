...
\begin{verbatim}
valeurs : [0.12222222 0.07777778 0.1        0.1        0.15555556 0.07777778
 0.16666667 0.08888889 0.1        0.12222222]
...
\begin{Highlighting}[]
\NormalTok{percentiles\_position}\OperatorTok{=}\NormalTok{ (}\DecValTok{0}\NormalTok{,}\FloatTok{0.1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{50}\NormalTok{,}\DecValTok{98}\NormalTok{,}\DecValTok{99}\NormalTok{,}\FloatTok{99.9}\NormalTok{,}\DecValTok{100}\NormalTok{)}
\NormalTok{values}\OperatorTok{=}\NormalTok{ xr.apply\_ufunc(}\KeywordTok{lambda}\NormalTok{ x: }\DecValTok{10} \OperatorTok{*}\NormalTok{ np.log10(x), img\_SAR[}\DecValTok{0}\NormalTok{]).data}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{values}\OperatorTok{=}\NormalTok{ np.sort(}\DecValTok{10}\OperatorTok{*}\NormalTok{np.log10(img\_SAR[}\DecValTok{0}\NormalTok{].data.flatten())) }\CommentTok{\# on range les valeurs par ordre croissant}
