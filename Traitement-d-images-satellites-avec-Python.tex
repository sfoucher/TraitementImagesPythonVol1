...
\begin{itemize}
\item
  \textbf{Parmi les matrices de pondération spatiale ci-dessous,
  lesquelles sont des matrices de contiguïté?}
  ...
  Relisez au besoin la \textbf{?@sec-012}.
\item
  \textbf{En anglais, comment est appelée une matrice selon le partage
  d'un nœud?}
  ...
  Relisez au besoin le début de la \textbf{?@sec-012}.
\item
  \textbf{Comparativement à une matrice de l'inverse de la distance, une
  matrice de l'inverse de la distance au carré accorde un poids plus
  important aux entités proches.}
  ...
  Relisez au besoin la \textbf{?@sec-01222}.
\item
  \textbf{Quels sont les avantages de la standardisation en ligne des
  ...
  \item
    La somme de l'ensemble de la matrice est égale au nombre d'entités
    spatiales.
  \item
    La standardisation permet de comparer la dépendance spatiale selon
    différentes matrices.
  \item
    La standardisation augmente la vitesse des calculs.
  \end{itemize}

  Relisez au besoin la \textbf{?@sec-0123}.
\item
  \textbf{Avec une matrice standardisée, la statistique du I de Moran
  ...
  Relisez au besoin la \textbf{?@sec-0142}.
\item
  \textbf{Quelles sont les trois manières de tester la significativité
  du I de Moran?}
  ...
  Relisez au besoin la \textbf{?@sec-0143}.
\item
  \textbf{Comment mesurer la dépendance spatiale d'un modèle MCO?}
  ...
  Relisez au besoin la \textbf{?@sec-0171}.
\item
  \textbf{Quel est le synonyme de l'hétérogénéité spatiale?}
  ...
  Relisez au besoin la \textbf{?@sec-0172}.
\end{itemize}
...
\tightlist
\item
  Parmi les matrices de pondération spatiale ci-dessous, lesquelles sont
  des matrices de contiguïté?
  ...
  \end{itemize}
\item
  En anglais, comment est appelée une matrice selon le partage d'un
  nœud?
  ...
  \end{itemize}
\item
  Comparativement à une matrice de l'inverse de la distance, une matrice
  de l'inverse de la distance au carré accorde un poids plus important
  aux entités proches.
  ...
  \end{itemize}
\item
  Quels sont les avantages de la standardisation en ligne des matrices
  ...
  \end{itemize}
\item
  Avec une matrice standardisée, la statistique du I de Moran varie
  théoriquement de :
  ...
  \end{itemize}
\item
  Quelles sont les trois manières de tester la significativité du I de
  Moran?
